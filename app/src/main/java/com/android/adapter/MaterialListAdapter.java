...
public class MaterialListAdapter extends RealmRecyclerViewAdapter<MaterialListItem, MaterialListAdapter.MyViewHolder> {
    ...
    class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        @BindView(R.id.textview_material_name) TextView textview_material_name;
        @BindView(R.id.textview_quantity_in) TextView textview_quantity_in;
        @BindView(R.id.textview_quantity_out) TextView textview_quantity_out;
        @BindView(R.id.textview_quantity_current) TextView textview_quantity_current;
        private Context context;
