...
public class HorizontalSelector extends View {
    ...
    public HorizontalSelector(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.horizontalSelectorStyle);
    }
    ...
    public HorizontalSelector(Context context, AttributeSet attrs, int defStyle) {
        ...
        textPaint = paint;
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.HorizontalSelector, defStyle, 0);
        CharSequence[] values;
        int ellipsize = 3; // END default value
        int sideItems = this.sideItems;
        try {
            textColor = a.getColorStateList(R.styleable.HorizontalSelector_android_textColor);
            if (textColor == null) {
                textColor = ColorStateList.valueOf(0xFF000000);
            }
            values = a.getTextArray(R.styleable.HorizontalSelector_values);
            ellipsize = a.getInt(R.styleable.HorizontalSelector_android_ellipsize, ellipsize);
            marqueeRepeatLimit = a.getInt(R.styleable.HorizontalSelector_android_marqueeRepeatLimit, marqueeRepeatLimit);
            dividerSize = a.getDimension(R.styleable.HorizontalSelector_dividerSize, dividerSize);
            sideItems = a.getInt(R.styleable.HorizontalSelector_sideItems, sideItems);
            float textSize = a.getDimension(R.styleable.HorizontalSelector_android_textSize, -1);
            if (textSize > -1) {
...
//            postInvalidateOnAnimation(); // TODO
    ...
    private static final class Marquee extends Handler {
        ...
        private final WeakReference<HorizontalSelector> mView;
        ...
        Marquee(HorizontalSelector v, Layout l, boolean rtl) {
            ...
            mView = new WeakReference<HorizontalSelector>(v);
        ...
        void tick() {
            ...
            final HorizontalSelector view = mView.get();
    ...
    public static class SavedState extends BaseSavedState {
        ...
        public String toString() {
            return "HorizontalSelector.SavedState{"
    ...
    private static class PickerTouchHelper extends ExploreByTouchHelper {
        private HorizontalSelector mPicker;

        public PickerTouchHelper(HorizontalSelector picker) {
            super(picker);
            mPicker = picker;
        }
