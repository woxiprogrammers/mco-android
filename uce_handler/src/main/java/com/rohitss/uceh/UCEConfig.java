...
public class UCEConfig implements Serializable {
    ...
    private UCEHandler.EventListener eventListener = null;
    ...
    @Nullable
    public UCEHandler.EventListener getEventListener() {
        return eventListener;
    }

    public void setEventListener(@Nullable UCEHandler.EventListener eventListener) {
    ...
    public static class Builder {
        private UCEConfig config;

        @NonNull
        public static Builder create() {
            Builder builder = new Builder();
            UCEConfig currentConfig = UCEHandler.getConfig();
            UCEConfig config = new UCEConfig();
        ...
        /**
         * Defines if UCEHandler crash interception mechanism is enabled.
         * Set it to true if you want UCEHandler to intercept crashes,
         ...
         * The default is R.drawable.UCEHandler_error_image (a cute upside-down bug).
         */
        @NonNull
         ...
         */
        @NonNull
        public Builder eventListener(@Nullable UCEHandler.EventListener eventListener) {
        ...
        @NonNull
        public UCEConfig get() {
            return config;
        }

        public void apply() {
            UCEHandler.setConfig(config);
        }
    }
}
